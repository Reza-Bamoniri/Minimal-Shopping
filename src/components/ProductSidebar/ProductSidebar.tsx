...
const ProductSidebar = ({
  ...
  return (
    <>
      <div
        style={{ right: isOpen ? "4px" : "-150%" }}
        className="bg-white py-5 pr-50 pl-6 fixed top-4 bottom-4 rounded-2xl shadow-xl z-50 transition-all duration-400"
      >
        <div className=" w-60  mb-5 relative group">
          <button
            onClick={onClose}
            className="w-10 h-10 rounded-full bg-gray-200 text-gray-800 font-bold cursor-pointer flex items-center justify-center absolute top-0 -right-50"
          >
            ✕
          </button>
          <div>
          ...
          <div className="mt-3.25">
            ...
            <p className="text-black">{product?.category || "100% Cotton"}</p>
            ...
            <div className="mt-3.25">
              ...
              >
                ...
                />
                <path
                  d="M34 1L36.163 5.60778L41 6.35121L37.5 9.93586L38.326 15L34 12.6078L29.674 15L30.5 9.93586L27 6.35121L31.837 5.60778L34 1Z"
                  fill="#FE8A00"
                  stroke="#FE8A00"
                  strokeWidth="2"
                  strokeLinecap="round"
                ...
                />
                <path
                  d="M60 1L62.163 5.60778L67 6.35121L63.5 9.93586L64.326 15L60 12.6078L55.674 15L56.5 9.93586L53 6.35121L57.837 5.60778L60 1Z"
                  fill="#FE8A00"
                  stroke="#FE8A00"
                  strokeWidth="2"
                  strokeLinecap="round"
                ...
                />
                <path
                  d="M86 1L88.163 5.60778L93 6.35121L89.5 9.93586L90.326 15L86 12.6078L81.674 15L82.5 9.93586L79 6.35121L83.837 5.60778L86 1Z"
                  stroke="#FE8A00"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M112 1L114.163 5.60778L119 6.35121L115.5 9.93586L116.326 15L112 12.6078L107.674 15L108.5 9.93586L105 6.35121L109.837 5.60778L112 1Z"
                  stroke="#FE8A00"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
