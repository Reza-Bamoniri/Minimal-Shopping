...
className="bg-white py-5 px-6 fixed top-4 bottom-4 rounded-2xl shadow-xl z-50"
      >
        ...
        <div className="w-full mt-15 flex justify-between items-center relative">
          ...
          <div className="flex gap-3 items-center text-xl font-medium text-gray-400 absolute -right-1">
            <span>
