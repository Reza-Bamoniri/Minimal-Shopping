...
const ProductSidebar = () => {
  return (
    ...
    <div className="bg-white py-5 pr-50 pl-6 fixed top-4 -right-150 bottom-4 rounded-2xl shadow-xl  z-50">
        
        <div className="w-fit mb-5 relative group">
            <button className="w-10 h-10 rounded-full bg-gray-200 text-gray-800 font-bold cursor-pointer flex items-center justify-center absolute top-0 -right-50">✕</button>
       <div>
            
            <div className="relative group">
            <img className="w-60 rounded-2xl" src="/images/images (1).jpg" alt="" />
            </div>
      ...
      <button className="flex items-center justify-center w-1/3 h-full cursor-pointer">
       <div className="flex items-center justify-center w-5 h-5 rounded-full border border-gray-400 text-gray-400 font-light">
      -
      </div>
     </button>
    ...
    <button className="flex items-center justify-center w-1/3 h-full cursor-pointer">
      <div className="flex items-center justify-center w-5 h-5 rounded-full border border-pink-500 text-pink-500  font-light">
      +
      </div>
   </button>
        ...
        {["S", "M", "L", "XL", "XXL"].map((size) => (
          <button
            key={size}
            className="w-10 h-10 border border-orange-500 rounded-lg text-orange-500 cursor-pointer hover:border-orange-400 hover:text-orange-400"
          >
            {size}
          </button>
        ))}
    ...
    <div className="flex items-center gap-3">
      <button className="px-6 py-1 border border-orange-500 rounded-full text-orange-500 cursor-pointer hover:text-white hover:bg-orange-500 duration-300 ">
        Add to cart
      </button>
    ...
    <div className="flex gap-3 items-center text-xl font-medium text-gray-400 absolute  -right-42.5">
