            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_300px] gap-4 p-5">
              <div className="flex flex-col gap-4">
                <div className="border border-gray-200 overflow-y-auto max-h-87.5 rounded-xl p-5">
                  ...
                  {cartItems.length === 0 && (
                    <p className="text-center text-gray-400 py-8">The Basket is empty</p>
                  )}

                  
                  {cartItems.map((item) => (
                    <div key={item.id} className="flex gap-4 items-start mb-4 pb-4 border-b border-gray-100 last:border-0 last:mb-0 last:pb-0">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start gap-2">
                          <div>
                            ...
                            <p className="text-xs text-gray-400 mt-0.5">{item.description.slice(0, 40)}...</p>
                          </div>
                ...
                <div className="border border-gray-200 rounded-xl p-5">
                  <div className="flex justify-between items-center mb-3">
                    <h2 className="text-lg font-semibold text-gray-600">Delivery Information</h2>
                    <button className="px-4 py-1.5 border border-orange-400 text-orange-400 text-sm rounded-full hover:bg-orange-400 transition-colors font-medium cursor-pointer hover:text-amber-50">
                      Edit
                    </button>
                  </div>
                  <div className="text-sm text-gray-600 space-y-1">
                    <p className="font-medium text-gray-700">Wade John Smith</p>
                    <p>New Zealand - 2nd Cross</p>
                    <p className="mt-2">Cross raod - Po 25698</p>
                    <p>United States</p>
                  </div>
                </div>
              </div>
              ...
              <div className="border border-gray-200 rounded-xl h-full">
                <div className="p-5">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex flex-col">
                      <span className="text-gray-900 font-medium">Products added</span>
                      <span className="text-gray-500 mb-1">{totalItems}</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-gray-900 font-medium mb-1">GST</span>
                      <span className="text-gray-500 mb-1">1.25%</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-gray-900 font-medium mb-1">S-GST</span>
                      <span className="text-gray-500 mb-1">1.25%</span>
                    </div>
                    
                    <div className="flex flex-col">
                      <span className="text-gray-900 font-medium mb-1">Total Cart Value <span className="text-gray-500 font-normal">(in $)</span></span>
                      <span className="text-gray-500 mb-1">${totalPrice.toFixed(2)}</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-gray-900 font-medium mb-1">Discount <span className="text-gray-500 font-normal">(in %)</span></span>
                ...
                <div className="flex items-start flex-col w-full mt-15">
                  <div className="flex gap-3 items-center rounded-t-lg bg-gray-100 w-full p-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-700">Delivery limit</p>
                      <p className="text-xs text-gray-500 mt-0.5">Free delivery within 50 km's.</p>
                    </div>
                  </div>

                  <div className="flex gap-3 items-center rounded-b-lg bg-gray-100 w-full p-3">
                    <div className="mt-0.5 shrink-0">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-700">Return Policy</p>
                      <p className="text-xs text-gray-500 mt-0.5">With-in 5 days of product delivery.</p>
                    </div>
                  </div>
                </div>
              </div>
