...
const CartModal = ({ onCloseCartModal }: Props) => {
  ...
  return (
    <>
        ...
        <div onClick={onCloseCartModal} className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div onClick={(e) => e.stopPropagation()} className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl relative">
            <button
                ...
                <div className="p-5">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-gray-500 mb-2">${totalPrice.toFixed(2)}</span>
                    </div>
                    <div className="flex flex-col">
