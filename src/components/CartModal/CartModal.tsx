const CartModal = ({ onCloseCartModal }) => {
  return (
    <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_300px] gap-4 p-5">
              <div className="flex flex-col gap-4">
                <div className="border border-gray-200 rounded-xl p-5">
                  ...
                  <div className="flex gap-4 items-start mb-4 pb-4 ">
              ...
              <div className="border border-gray-200 rounded-xl h-fit">
                <div className="p-5">
                    <h2 className="text-lg font-semibold text-gray-800 mb-4">
                  Order Summary
                </h2>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex flex-col">
                    <span className="text-gray-900 font-medium">S-GST</span>
                    <span className=" text-gray-500">1.25%</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-gray-900 font-medium">
                    ...
                    <span className=" text-gray-500">275$</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-gray-900 font-medium">
                      Discount{" "}
