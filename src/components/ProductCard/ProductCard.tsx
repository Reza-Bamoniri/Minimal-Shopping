        ...
        <div className="mt-3.25">
          ...
          <div className="flex gap-1 mt-3.25">
            {[1, 2, 3, 4, 5].map((star) => (
              ...
              >
                <path
                  d="M60 5L73.04 42.3H112.36L80.66 64.9L93.7 102.2L60 79.6L26.3 102.2L39.34 64.9L7.64 42.3H46.96L60 5Z"
                  fill={
                    star <= Math.round(product.rating.rate) ? "#FE8A00" : "none"
                  }
                  stroke="#FE8A00"
                  strokeWidth="8"
                  strokeLinecap="round"
